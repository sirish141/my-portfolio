  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 px-4">
      <div className="text-center z-10 relative w-full">
        <h1 className={`text-4xl sm:text-6xl md:text-9xl font-light mb-4 sm:mb-6 transition-all duration-1500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
        ...
        <p className={`text-base sm:text-lg md:text-xl text-gray-400 max-w-xl mx-auto mb-8 sm:mb-12 animate-fade-in-up transition-all duration-1500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{ animationDelay: '1s' }}>
